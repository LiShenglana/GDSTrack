...
def eval_one_model(cfg):
    ...
    if ('got10k' in cfg.benchmark or 'lasot' in cfg.benchmark
            ...
            or 'GTOT' in cfg.benchmark or 'RGBT234' in cfg.benchmark or 'LasHeR_test' in cfg.benchmark or 'VTUAV' in cfg.benchmark):
...
if __name__ == '__main__':
    ...
    parser.add_argument('-t', '--train_set', default='LasHeR',  # foder name of results
                        type=str, required=False,
    ...
    parser.add_argument('-b', '--benchmark', default='GTOT',  # GTOT, RGBT234, LasHeR_test, VTUAV
                        type=str, required=False,
    ...
    parser.add_argument('--test_epoch', default=20,  # 300
