...
def init_distributed_mode(args):
    if 'RANK' in os.environ and 'WORLD_SIZE' in os.environ:
        args.world_size = int(os.environ['WORLD_SIZE'])  # num of process
        args.rank = int(os.environ["RANK"])  # node id
        args.local_rank = int(os.environ['LOCAL_RANK'])  # gpu id on this node
