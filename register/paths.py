...
path_register.project_dir = '/home/cscv/Documents/lsl/MATPrompt (baseline)'
...
if socket.gethostname() == 'z390':
    ...
    lmdb_dir = '/media/cscv/d00985a0-c3e6-4ffa-9546-88c861db5ce3/02_Dataset/LasHeR/LMDB'

path_register.lmdb = Edict()
path_register.json = Edict()

#LasHeR
path_register.lmdb.LasHeR_train = p_join(lmdb_dir, 'LasHeR_train')
path_register.lmdb.LasHeR_val = p_join(lmdb_dir, 'LasHeR_val')

path_register.json.LasHeR_train = p_join(path_register.lmdb.LasHeR_train, 'LasHeR_train.json')
path_register.json.LasHeR_val = p_join(path_register.lmdb.LasHeR_val, 'LasHeR_val.json')
...
# else:
#     benchmark_dir = '/media/cscv/d00985a0-c3e6-4ffa-9546-88c861db5ce3/02_Dataset'

benchmark_dir2 = '/home/cscv/Documents/lsl/dataset'
benchmark_dir = '/media/cscv/d00985a0-c3e6-4ffa-9546-88c861db5ce3/02_Dataset'

path_register.benchmark = Edict()

path_register.benchmark.LasHeR_train = p_join(benchmark_dir, 'LasHeR/trainingset')
path_register.benchmark.LasHeR_test = p_join(benchmark_dir, 'LasHeR/testingset')
path_register.benchmark.VTUAV= p_join(benchmark_dir, 'VTUAV')
path_register.benchmark.GTOT = p_join(benchmark_dir2, 'GTOT')
path_register.benchmark.RGBT234 = p_join(benchmark_dir2, 'RGB-T234')
