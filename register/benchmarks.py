...
from lib.benchmark.benchmark_loaders import (load_got10k, load_lasot, load_trackingnet, load_tnl2k, load_votlt,
                                             ...
                                             load_otb, load_nfs, load_uav, load_GTOT, load_RGBT234, load_LasHeR_test, load_VTUAV)
...
benchmark_register.update({
    ...
    'GTOT': partial(load_GTOT, root=path.benchmark.GTOT),
    'RGBT234': partial(load_RGBT234, root=path.benchmark.RGBT234),
    'LasHeR_test': partial(load_LasHeR_test, root=path.benchmark.LasHeR_test),
    'VTUAV': partial(load_VTUAV, root=path.benchmark.VTUAV),
