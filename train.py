...
if __name__ == '__main__':
    ...
    parser.add_argument('-e', '--experiment', default='translate_track',   #translate_template
    ...
    parser.add_argument('-t', '--train_set', default='LasHeR',
                        type=str, required=False,
    ...
    parser.add_argument('--pretrain_name', default='/home/cscv/Documents/lsl/MATPrompt (baseline)/checkpoints/translate_template_common_pretrain/translate_template_common_pretrain_E500.pth',
                        type=str, required=False,
